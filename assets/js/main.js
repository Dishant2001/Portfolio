...
(function() {
  ...
  // element.addEventListener("click", () => {
	//   alert('hello');
  //   // document.getElementById('portfolio-img').src="assets/img/portfolio/portfolio-1.png";
  //   // document.getElementById("portfolio-img").src="portfolio-1.png";
